  ...
  return (
    <div className="border border-gray-200 rounded-2xl p-6 bg-white flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="badge badge-info badge-outline rounded-full text-xs px-3"> {technology.badge}
        </span>
      ...
      <div className="flex items-center justify-between text-sm">
        <span className="badge badge-ghost rounded-md text-xs">{technology.category}</span>
        <span className="text-gray-500">{technology.difficulty}</span>
        <span className="flex items-center gap-1 text-gray-700"> ⭐ {technology.rating}</span>
      </div>
